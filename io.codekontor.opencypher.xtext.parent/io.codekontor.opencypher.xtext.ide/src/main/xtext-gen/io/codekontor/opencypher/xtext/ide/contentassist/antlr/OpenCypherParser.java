...
public class OpenCypherParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OpenCypherGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCypherAccess().getStatementAssignment_2(), "rule__Cypher__StatementAssignment_2");
			...
			builder.put(grammarAccess.getWithAccess().getDistintAssignment_1(), "rule__With__DistintAssignment_1");
			builder.put(grammarAccess.getWithAccess().getReturnBodyAssignment_2(), "rule__With__ReturnBodyAssignment_2");
			builder.put(grammarAccess.getWithAccess().getWhereAssignment_3(), "rule__With__WhereAssignment_3");
			builder.put(grammarAccess.getReturnAccess().getReturnAssignment_0(), "rule__Return__ReturnAssignment_0");
			builder.put(grammarAccess.getReturnAccess().getDistinctAssignment_1(), "rule__Return__DistinctAssignment_1");
			builder.put(grammarAccess.getReturnAccess().getBodyAssignment_2(), "rule__Return__BodyAssignment_2");
			builder.put(grammarAccess.getReturnBodyAccess().getReturnItemsAssignment_0(), "rule__ReturnBody__ReturnItemsAssignment_0");
			builder.put(grammarAccess.getReturnBodyAccess().getOrderAssignment_1(), "rule__ReturnBody__OrderAssignment_1");
			builder.put(grammarAccess.getReturnBodyAccess().getSkipAssignment_2(), "rule__ReturnBody__SkipAssignment_2");
			builder.put(grammarAccess.getReturnBodyAccess().getLimitAssignment_3(), "rule__ReturnBody__LimitAssignment_3");
