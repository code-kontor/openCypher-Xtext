 ...
 * </p>
 * <ul>
 *   <li>{@link io.codekontor.opencypher.xtext.openCypher.BulkImportQuery#getPeriodicCommitHint <em>Periodic Commit Hint</em>}</li>
 *   <li>{@link io.codekontor.opencypher.xtext.openCypher.BulkImportQuery#getLoadCSVQuery <em>Load CSV Query</em>}</li>
 * </ul>
 *
 * @see io.codekontor.opencypher.xtext.openCypher.OpenCypherPackage#getBulkImportQuery()
 * @model
 * @generated
 */
public interface BulkImportQuery extends Query
{
   ...
   * @see io.codekontor.opencypher.xtext.openCypher.OpenCypherPackage#getBulkImportQuery_PeriodicCommitHint()
  ...
  /**
   * Sets the value of the '{@link io.codekontor.opencypher.xtext.openCypher.BulkImportQuery#getPeriodicCommitHint <em>Periodic Commit Hint</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see io.codekontor.opencypher.xtext.openCypher.OpenCypherPackage#getBulkImportQuery_LoadCSVQuery()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link io.codekontor.opencypher.xtext.openCypher.BulkImportQuery#getLoadCSVQuery <em>Load CSV Query</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
