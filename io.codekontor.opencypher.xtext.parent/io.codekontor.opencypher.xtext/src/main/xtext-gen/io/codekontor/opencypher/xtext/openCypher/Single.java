 ...
 * </p>
 * <ul>
 *   <li>{@link io.codekontor.opencypher.xtext.openCypher.Single#getFilterExpression <em>Filter Expression</em>}</li>
 * </ul>
 *
 * @see io.codekontor.opencypher.xtext.openCypher.OpenCypherPackage#getSingle()
 * @model
 * @generated
 */
public interface Single extends Expression
{
   ...
   * @see io.codekontor.opencypher.xtext.openCypher.OpenCypherPackage#getSingle_FilterExpression()
  ...
  /**
   * Sets the value of the '{@link io.codekontor.opencypher.xtext.openCypher.Single#getFilterExpression <em>Filter Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
