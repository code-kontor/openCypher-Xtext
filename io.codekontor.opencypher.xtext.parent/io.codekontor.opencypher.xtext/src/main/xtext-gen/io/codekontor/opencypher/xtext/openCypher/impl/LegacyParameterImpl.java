 ...
 * </p>
 * <ul>
 *   <li>{@link io.codekontor.opencypher.xtext.openCypher.impl.LegacyParameterImpl#getNodeLabels <em>Node Labels</em>}</li>
 *   <li>{@link io.codekontor.opencypher.xtext.openCypher.impl.LegacyParameterImpl#getPropertyLookups <em>Property Lookups</em>}</li>
 *   <li>{@link io.codekontor.opencypher.xtext.openCypher.impl.LegacyParameterImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LegacyParameterImpl extends PropertiesImpl implements LegacyParameter
{
  ...
  public EList<NodeLabel> getNodeLabels()
  {
    if (nodeLabels == null)
    {
      nodeLabels = new EObjectContainmentEList<NodeLabel>(NodeLabel.class, this, OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS);
    }
    return nodeLabels;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == NodeLabels.class)
    {
      ...
      {
        case OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS: return OpenCypherPackage.NODE_LABELS__NODE_LABELS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == NodeLabels.class)
    {
      ...
      {
        case OpenCypherPackage.NODE_LABELS__NODE_LABELS: return OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS;
        default: return -1;
      }
    }
    if (baseClass == PropertyExpression.class)
