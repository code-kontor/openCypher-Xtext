 ...
 * </p>
 * <ul>
 *   <li>{@link io.codekontor.opencypher.xtext.openCypher.With#isDistint <em>Distint</em>}</li>
...
public interface With extends Clause
{
   ...
   * @see io.codekontor.opencypher.xtext.openCypher.OpenCypherPackage#getWith_Distint()
   * @model
   * @generated
   */
  boolean isDistint();
  ...
  /**
   * Sets the value of the '{@link io.codekontor.opencypher.xtext.openCypher.With#isDistint <em>Distint</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
