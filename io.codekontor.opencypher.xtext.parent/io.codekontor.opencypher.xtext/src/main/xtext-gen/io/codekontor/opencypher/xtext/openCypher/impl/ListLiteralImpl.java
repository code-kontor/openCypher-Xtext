 ...
 * </p>
 * <ul>
 *   <li>{@link io.codekontor.opencypher.xtext.openCypher.impl.ListLiteralImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListLiteralImpl extends LiteralImpl implements ListLiteral
{
  ...
  {
    return OpenCypherPackage.Literals.LIST_LITERAL;
  }
  ...
  public EList<Expression> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EObjectContainmentEList<Expression>(Expression.class, this, OpenCypherPackage.LIST_LITERAL__EXPRESSIONS);
    }
    return expressions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OpenCypherPackage.LIST_LITERAL__EXPRESSIONS:
